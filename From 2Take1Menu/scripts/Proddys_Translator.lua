...
if not menu.is_trusted_mode_enabled(eTrustedFlags.LUA_TRUST_HTTP) then
	menu.notify("Script requires HTTP trusted flag", ScriptName .. " v" .. Version, 10, 0xFF0000FF)
end
...
menu.add_feature("Send Messages To Team Chat", "toggle", ParentId, function(f)
