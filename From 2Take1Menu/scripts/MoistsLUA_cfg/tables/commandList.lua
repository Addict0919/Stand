commandList = {
	...
	["tp"] = "local.settings.notifications.test_notification",
	["kick"] = "local.settings.notifications.test_notification",
	["explode"] = "local.settings.notifications.test_notification",
}
...
--allVehiclekeys = {}
--local vehiclesFeat = menu.get_feature_by_hierarchy_key("spawn.vehicles")
--local excludedChildren = {
--    ["Options"] = true,
--    ["Spawn Vehicle Input"] = true
--}
--for i=1,vehiclesFeat.child_count do
--    local child = vehiclesFeat.children[i]
--    if not excludedChildren[child.name] then
--        for j=1,child.child_count do
--            local spawnFeat = child.children[j]
--            allVehiclekeys[spawnFeat.name:lower()] = spawnFeat
--        end
--    end
--end