...
GenerateFeatures = function(pid)
    ...
    menu.toggle_loop(malicious, "Chicken Crash", {""}, "", function()
		...
		local object = entities.create_object(util.joaat("prop_paints_pallete01"), ENTITY.GET_ENTITY_COORDS(PLAYER.GET_PLAYER_PED_SCRIPT_INDEX(pid)))
		local object = entities.create_object(util.joaat("prop_logpile_04"), ENTITY.GET_ENTITY_COORDS(PLAYER.GET_PLAYER_PED_SCRIPT_INDEX(pid)))
        util.yield(1)
    end)
