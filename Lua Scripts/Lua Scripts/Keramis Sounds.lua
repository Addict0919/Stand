...
menu.action(menu.my_root(), "Stop all sounds", {"kstopall", "kstopallsounds"}, "Stops all sounds. Credit to [hungwy] on the Stand discord for telling me the method.", function ()
    for i=0,99 do
       AUDIO.STOP_SOUND(i)
       util.yield() 
    end
...
local function playerActionsSetup(pid)
    menu.divider(menu.player_root(pid), "sounds")
