...
menu.divider(menu.my_root(), "Vehicles")

menu.action(menu.my_root(), "Search vehicle", {"lssearchv"}, "", function(click_type)
...
local load_vehicle_action = menu.list_action(menu.my_root(), "Load vehicle", {}, "Load a vehicle. " .. instruction_text, all_vehicles, function(index, value)
...
loaded_vehicles_root = menu.list(menu.my_root(), "Currently loaded vehicles", {"lancespoonerloadedvehicles"}, "Vehicles you have spawned")


menu.divider(menu.my_root(), "Maps")
menu.action(menu.my_root(), "Search map", {"lssearchmap"}, "", function(click_type)
...
local load_map_action = menu.list_action(menu.my_root(), "Load map", {}, "Load a map. " .. instruction_text, all_maps, function(index, value)
...
loaded_maps_root = menu.list(menu.my_root(), "Currently loaded maps", {"lancespoonerloadedmaps"}, "Maps you have loaded")


menu.divider(menu.my_root(), "Favorites")

local load_favorite_vehicle_action = menu.list_action(menu.my_root(), "Favorite vehicles", {}, "Load a vehicle.", favorite_vehicles, function(index, value)
    load_vehicle(vehicles_dir .. '\\' .. value)
end)

local load_favorite_map_action = menu.list_action(menu.my_root(), "Favorite maps", {}, "Load a map.", favorite_maps, function(index, value)
...
v_search_results = {}
v_search_results_action = menu.list_action(menu.my_root(), "Vehicle search results", {"lsvsearchresults"}, instruction_text, v_search_results, function(index, value)
    local path = vehicles_dir .. '\\' .. value
    if util.is_key_down(0x10) and util.is_key_down(0x11) then
        os.remove(path)
        util.toast(value .. " deleted! :)")
...
m_search_results = {}
m_search_results_action = menu.list_action(menu.my_root(), "Map search results", {"lsmsearchresults"}, instruction_text, m_search_results, function(index, value)
    local path = maps_dir .. '\\' .. value
    if util.is_key_down(0x10) and util.is_key_down(0x11) then
        os.remove(path)
        util.toast(value .. " deleted! :)")
