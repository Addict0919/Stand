...
GenerateFeatures = function(pid)
    ...
    menu.toggle_loop(malicious, "Crate Crash", {""}, "", function()
        local object = entities.create_object(util.joaat("prop_box_wood02a_pu"), ENTITY.GET_ENTITY_COORDS(PLAYER.GET_PLAYER_PED_SCRIPT_INDEX(pid)))
		local object = entities.create_object(util.joaat("prop_box_wood02a_pu"), ENTITY.GET_ENTITY_COORDS(PLAYER.GET_PLAYER_PED_SCRIPT_INDEX(pid)))
		local object = entities.create_object(util.joaat("prop_box_wood02a"), ENTITY.GET_ENTITY_COORDS(PLAYER.GET_PLAYER_PED_SCRIPT_INDEX(pid)))
        util.yield(50)
    end)
	
	menu.toggle_loop(malicious, "E-Cola Troll", {""}, "", function()
        local object = entities.create_object(util.joaat("xs_prop_can_wl"), ENTITY.GET_ENTITY_COORDS(PLAYER.GET_PLAYER_PED_SCRIPT_INDEX(pid)))
		local object = entities.create_object(util.joaat("xm3_prop_can_wl"), ENTITY.GET_ENTITY_COORDS(PLAYER.GET_PLAYER_PED_SCRIPT_INDEX(pid)))
        util.yield(300)
    end)
	
	menu.toggle_loop(malicious, "trailerlove Troll", {""}, "", function()
		...
		local vehicle = entities.create_vehicle(util.joaat("BMX"), ENTITY.GET_ENTITY_COORDS(PLAYER.GET_PLAYER_PED_SCRIPT_INDEX(pid)))
		local object = entities.create_object(util.joaat("boattrailer"), ENTITY.GET_ENTITY_COORDS(PLAYER.GET_PLAYER_PED_SCRIPT_INDEX(pid)))
        util.yield(100000000)
    end)
